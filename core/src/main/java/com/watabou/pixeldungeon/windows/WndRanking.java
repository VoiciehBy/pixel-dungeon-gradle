...
public class WndRanking extends WndTabbed {
    ...
    private class StatsTab extends Group {
        ...
        private static final String TXT_TITLE = "Level %d %s %s %s";//VRB modified
        ...
        public StatsTab() {
            ...
            String heroName = Dungeon.hero.name();//VRB

            IconTitle title = new IconTitle();
            title.icon(HeroSprite.avatar(Dungeon.hero.heroClass, Dungeon.hero.tier()));
            title.label(Utils.format(TXT_TITLE, Dungeon.hero.lvl, heroName, heroClass, heroGender.charAt(0)).toUpperCase(Locale.ENGLISH));//VRB modified
